...
Legacy diagnostic/ablation output. The final report reproduction does not use
this table; event/tail experiments use
`results/intermediates/three_schedule_momentum/predictions.csv` instead.
